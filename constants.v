...
prove_sup...
pattern 5%R at 1 in |- *; rewrite (Rmult_comm 5); do 3 rewrite Rmult_assoc;
 rewrite <- Rinv_l_sym...
prove_sup...
discrR...
discrR...
...
right; unfold PI_ub in |- *; unfold Rdiv in |- *; rewrite Rmult_assoc;
...
apply PI4_RLT_PI2...
split...
unfold Rdiv in |- *; repeat apply Rmult_lt_0_compat...
apply rho_lb_pos...
apply Rlt_le_trans with MinT...
apply MinT_is_pos...
apply (cond_1 t)...
...
Proof with trivial.
intro t; unfold m in |- *; repeat apply Rmult_lt_0_compat...
simpl in |- *; prove_sup0...
apply r_V_is_pos...
